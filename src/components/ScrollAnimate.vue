<template>
  ...
  <section>
    ...
    <div class="sticky bottom-0">
      <div class="relative mx-2 bg-gray-700 shadow-md rounded max-h-[75vh] overflow-hidden select-none">
        <div class="flex items-center justify-center px-1 pt-1 pb-0">
          <div class="relative flex items-center w-2/3 px-2 py-1 text-gray-100 bg-gray-600 rounded-md md:py-1 md:px-3">
            <span>example.com</span><svg xmlns="http://www.w3.org/2000/svg" class="absolute w-4 h-4 right-1 md:h-5 md:w-5" fill="none" viewBox="0 0 7 7"><path fill="#fff" fill-opacity="0.8" d="M5.088 4.004l-.125.126.125.125.126-.125-.126-.126zm-1.073-.822l.948.948.251-.252-.948-.948-.251.252zm1.2.948l.947-.948-.251-.252-.948.948.251.252z"></path><path stroke="#fff" stroke-linecap="round" stroke-opacity="0.8" stroke-width="0.355" d="M4.26 4.966a1.659 1.659 0 11.829-1.436"></path></svg>
          </div><div class="absolute flex gap-1 p-2 left-1">
            <div class="w-2 h-2 bg-gray-400 rounded-full md:h-3 md:w-3"></div>
            <div class="w-2 h-2 bg-gray-400 rounded-full md:h-3 md:w-3"></div>
            <div class="w-2 h-2 bg-gray-400 rounded-full md:h-3 md:w-3"></div>
          </div>
        </div><div class="px-2 pt-1 pb-2">
          <div class="relative bg-white text-gray-600 p-2 h-25vh flex rounded md:rounded-lg overflow-hidden undefined">
            <div
  ...
  <section class="h-50vh grid content-center">
    <h1>Other section...</h1>
  </section>
</template>
